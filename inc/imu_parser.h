...
struct ImuRawData {
  ...
  ImuRawData()
      : ax(0), ay(0), az(0), wx(0), wy(0), wz(0), hx(0), hy(0), hz(0), q0(0), q1(0), q2(0), q3(0), roll(0), pitch(0),
        yaw(0), temp(0), has_accel(false), has_gyro(false), has_mag_norm(false), has_mag_strength(false),
